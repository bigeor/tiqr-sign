...
- (void)processChallenge:(NSString *)scanResult {
        ...
        __block NSString *errorTitle = nil;
        ...
        if (url != nil && [url.scheme isEqualToString:authenticationScheme]) {
            ...
            challenge = [[SignChallenge alloc] initWithRawChallenge:scanResult managedObjectContext:self.managedObjectContext];
        } else if (url != nil && [url.scheme isEqualToString:decryptionScheme]) {
            challenge = [[DecryptChallenge alloc] initWithRawChallenge:scanResult managedObjectContext:self.managedObjectContext];
        } else {
